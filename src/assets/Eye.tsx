...
export const Eye = ({ size = 24, color = 'black', onPress }: SvgPropsType) => {
  return (
    <Svg width={size} height={size} fill="none" viewBox="0 0 36 37" onPress={onPress}>
      <Path stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M28.5 21.071c0 3.55-4.701 6.43-10.5 6.43S7.5 24.62 7.5 21.07s4.701-6.427 10.5-6.427 10.5 2.877 10.5 6.427Z" clip-rule="evenodd" />
      <Path stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20.625 21.071A2.625 2.625 0 1 1 18 18.501a2.598 2.598 0 0 1 2.625 2.57v0Z" clip-rule="evenodd" />
